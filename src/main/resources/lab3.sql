...
passport_seria VARCHAR(20) NULL,
...
PRIMARY KEY (id),
CONSTRAINT fk_delivery_address_city
FOREIGN KEY (city_name)
REFERENCES city (name)
ON DELETE NO ACTION
ON UPDATE NO ACTION)
...
CREATE TABLE package(
  ...
  CONSTRAINT fk_package_parcel_machine
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_package_delivery_address
...
INSERT INTO sender (name, surname, phone_number, passport_seria) VALUES
('Yura', 'Hryshkin', '+38099568236', '0012356'),
('Igor', 'Naliv', '+38099789823', '1235694'),
('Maxym', 'Gort', '+38096789823', '6589452');

INSERT INTO recipient(name, surname, phone_number, passport_seria, street, zip, city_name) VALUES
...
INSERT INTO delivery_address (street, city_name) VALUES
('Nova 96/8', 'Lviv'),
('Pole 98', 'Lutsk'),
('Zelena  68', 'Kharkiv');

INSERT INTO package (weigh, description, post_office_id, recipient_id, sender_id, parcel_machine_id, delivery_address_id) VALUES
